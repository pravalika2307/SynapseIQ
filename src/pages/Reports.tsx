                  ...
                  >
                    <div className="flex items-center justify-between border-b border-white/5 pb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-15 font-bold text-white/95 font-sans tracking-tight">{heading}</h3>
                      </div>
                      <span className="text-10 font-mono text-white/30 uppercase tracking-widest">Part 0{idx + 1}</span>
                    </div>

                    <p className="text-14 text-white/85 leading-relaxed font-sans max-w-[900px]">
                      {content}
                    </p>
