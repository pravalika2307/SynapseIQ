...
export const Topbar: React.FC = () => {
  ...
  return (
    <header className="flex items-center h-13 px-6 bg-background/95 backdrop-blur-md border-bottom border-white/5 sticky top-0 z-50 justify-between gap-4 select-none shrink-0 border-b">
      {/* Brand */}
      ...
      <div className="flex items-center gap-3">
        {datasetName && (
          <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 bg-white/[0.02] border border-white/5 rounded-md text-11 text-white/50 font-mono">
        ...
        <div className="w-7 h-7 rounded-full bg-gradient-to-br from-indigo-950 to-slate-900 border border-white/10 flex items-center justify-center text-10 font-bold text-white/70">
          AM
        </div>
      </div>
    </header>
